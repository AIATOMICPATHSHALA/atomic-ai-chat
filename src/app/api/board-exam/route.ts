...
import { generateBoardExamContent } from "@/lib/gemini";
import { buildBoardExamPrompt, parseBoardExamJson, BOARDS, type BoardClass, type BoardLanguage, type BoardMode } from "@/lib/boardExam";
